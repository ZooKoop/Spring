<template>
  <div>
    ...
    <el-drawer title="增加Ticket" :visible.sync="drawer" :before-close="handleClose" size="50%"><AddForm style="padding: 10px;"></AddForm></el-drawer>
    <data-tables
      :data="data"
...
export default {
  ...
  mounted: function() {
    this.axios
      .get('http://localhost:8080/whale/back/work/queryAll')
      .then(response => {
